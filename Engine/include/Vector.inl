...
// Helper code reduction macro to add assignment operators for the currently defined vector.
...
// Helper code reduction macro to add global operators for the currently defined vector.
